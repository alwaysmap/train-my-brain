# Quality gates — `/tmb:tmb-create`

Loaded at the very end of `/tmb:tmb-create`, before declaring delivery complete. The orchestrator should have a green check on every line below; if any is red, the delivery block lies.
